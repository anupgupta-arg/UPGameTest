...
@objc public class CalculatorScreenVC: UIViewController {
    @objc public var AMCalculatorDelegate: AMCalculatorTextFieldDelegate?;
...
//                    inputLabel.text = inputStr
    ...
    @IBAction func BackButtonAction(_ sender: Any) {
        if (self.AMCalculatorDelegate != nil) {
            self.AMCalculatorDelegate?.onBackPressed?();
        }
    }
...
@objc public protocol AMCalculatorTextFieldDelegate: NSObjectProtocol {
